...
function KayitOl() {
  ...
  return (
    <div className="max-w-screen-xl mx-auto flex items-center justify-center px-4 py-8 lg:py-22 lg:px-6 w-full mt-16"> {/* mt-16: Header yüksekliği kadar boşluk bırakıyoruz */}
      <div className="min-h-screen max-w-lg flex flex-col items-center justify-center bg-white shadow-md rounded-lg p-6">
        <form onSubmit={handleSubmit} className="mt-4 z-0" style={{ width: '430px', background: 'rgba(211, 211, 211, 0.6)', backdropFilter: 'blur(10px)', height: '510px', borderRadius: '10px', padding: '30px', boxShadow: '1px 2px 4px 2px' }}>
          <h1 className="text-2xl font-bold flex justify-center">Sign Up</h1>
          
          {/* User name input */}
          <div className="flex flex-row" style={{ width: '100%', height: '50px', margin: '30px 0px 10px 0px'
            , position: 'relative' }}>
            <input
              type="text"
              name="username"
          ...
          {touched.username && errors.username && (<div style={{height:'1px'}}><p className="flex flex-col items-center justify-center text-sm mt-1 w-full text-left" style={{ fontSize: '12px' }}>{errors.username}</p></div>)}

          {/* Email input */}
          <div className="flex flex-row" style={{ width: '100%', height: '50px', margin: '30px 0px 10px 0px', position: 'relative' }}>
            <input
              type="email"
              name="email"
              placeholder="Email"
          ...
          {/* Submit button */}
          <div className="flex flex-row items-center" style={{ width: '100%', height: '50px', margin: '30px 0px' }}>
            <button type="submit" className="focus:border-none h-12" style={{ width: '100%', borderRadius: '40px', backgroundColor: 'white', boxShadow: '0 0 10px rgba(0,0,0,.1)', fontSize: '16px' }}>
              Kayıt Ol
            </button>
          </div>
        </form>
